  ...
  return (
    <html lang="es">
      <body>
        ...
        <Script id="ecosystem-analytics" src="https://proactivitis-ads-control.vercel.app/ecosystem-analytics.js" data-site="Caribbean Buggy" strategy="afterInteractive" />
        <AnalyticsEvents />
        <VisitTracker />
        {analyticsId ? (
          <>
